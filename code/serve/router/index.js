...
/*----------------------admin-------------------------------*/
    ...
    // 活动列表请求
    router.get('/admin_demo_api/activity/topic/list', app.admin.list.list)
    router.post('/admin_demo_api/activity/topic/add', app.admin.list.add)
    router.post('/admin_demo_api/activity/topic/update', app.admin.list.update)
    router.get('/admin_demo_api/activity/topic/del', app.admin.list.del)
